...
var index = lunr(function () {
    ...
    index.add({
      ...
      category: ["docs"],
      content: "Hi everyone, today I’m bringing you a tutorial to learn how to create remote push notifications in ios using react native\n\n\n\n\n",
      tags: [],
      id: 1
    });
    ...
    index.add({
      ...
      category: ["docs"],
      content: "Hi everyone, today I’m bringing you a tutorial to learn how to create locally push notifications in ios using react native\n\n\n\n\n",
      tags: [],
      id: 2
    });
    ...
    index.add({
      ...
      category: ["docs"],
      content: "Hi everyone, today I’m bringing you a tutorial to learn how to avoid multiple render in React Native when we are using Redux in order to increase your apps performances.\n\n\n\n\n",
      tags: [],
      id: 3
    });
    ...
    index.add({
      ...
      category: ["docs"],
      content: "Hi everyone, today I want to show how to avoid multiple request when we are triggering an event when an input text is changing all the time, in order the make our code faster.\n\n\n\n\n",
      tags: [],
      id: 4
    });
...
var store = [{
    "title": "Descend Problem",
    "link": "/docs/descend-problem.html",
    "image": null,
    "date": "November 23, 2020",
    "category": ["docs"],
    "excerpt": "Hi everyone, it’s has been a long time since I uploaded my last post. Now I want to show you..."
},{
    "title": "React Native Push Notification in IOS Remotely",
    "link": "/docs/react-native-push-notification-in-ios-remotely.html",
    "image": null,
    "date": "January 20, 2019",
    "category": ["docs"],
    "excerpt": "Hi everyone, today I’m bringing you a tutorial to learn how to create remote push notifications in ios using react..."
},{
    "title": "React Native Push Notification in IOS Locally",
    "link": "/docs/react-native-push-notification-in-ios-locally.html",
    "image": null,
    "date": "January 20, 2019",
    "category": ["docs"],
    "excerpt": "Hi everyone, today I’m bringing you a tutorial to learn how to create locally push notifications in ios using react..."
},{
    "title": "Avoid multiple render in react native with redux",
    "link": "/docs/avoid-multiple-render-with-react-native-redux.html",
    "image": null,
    "date": "October 1, 2018",
    "category": ["docs"],
    "excerpt": "Hi everyone, today I’m bringing you a tutorial to learn how to avoid multiple render in React Native when we..."
},{
    "title": "Avoid multiple request on an input change event",
    "link": "/docs/avoid-multiple-request-on-input-change-event.html",
    "image": null,
    "date": "October 1, 2018",
    "category": ["docs"],
    "excerpt": "Hi everyone, today I want to show how to avoid multiple request when we are triggering an event when an..."
},{
    "title": "Sync Vs Async Request Promises JavaScript",
